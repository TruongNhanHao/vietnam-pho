<template>
    <div
        class="text-green-500 mb-28 text-xl py-10 px-52 flex flex-col items-center"
    >
        ...
        <div class="flex">
            <button
                class="uppercase p-5 font-bold bg-green-500 rounded-2xl hover:bg-green-400 mr-10 text-white"
