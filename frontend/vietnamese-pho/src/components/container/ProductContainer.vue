    ...
    >
        <div class="grid auto-rows-auto pb-0 p-10 bg-black mb-16">
            <div class="grid grid-cols-3">
                <span
                    class="font-bold mx-5 text-3xl mb-10 border-b-2 border-green-500 pb-5 text-center"
                    >Products</span
                >
                <span
                    class="font-bold mx-5 text-3xl mb-10 border-b-2 border-green-500 pb-5 text-center"
        ...
        <div>
            <button
                class="uppercase p-5 font-bold bg-green-500 rounded-2xl hover:bg-green-400 mr-10"
